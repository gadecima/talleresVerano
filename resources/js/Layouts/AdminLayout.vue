<template>
    <q-layout view="hHh lpR fFf">
        ...
        <q-drawer v-model="drawerOpen" side="left" bordered>
            <q-list>
                <q-item-label header class="text-primary">Menú</q-item-label>

                <q-item clickable tag="a" href="/admin/dashboard" active-class="bg-blue-1">
                    <q-item-section avatar>
                ...
                <q-item clickable tag="a" href="/admin/section1" active-class="bg-blue-1">
                    <q-item-section avatar>
                        <q-icon name="folder" />
                    </q-item-section>
                ...
                <q-item clickable tag="a" href="/admin/section2" active-class="bg-blue-1">
                    <q-item-section avatar>
                        <q-icon name="folder" />
                    </q-item-section>

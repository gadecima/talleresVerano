...
<head>
    ...
    <title>Reporte Cursantes por Taller</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Reporte de Cursantes por Taller</h1>
        <p>Período: {{ \Carbon\Carbon::create($anio, $mes, 1)->translatedFormat('F \d\e Y') }}</p>
    </div>

    <div class="info-section">
        <p><strong>Mes:</strong> {{ \Carbon\Carbon::create($anio, $mes, 1)->translatedFormat('F') }} - <strong>Año:</strong> {{ $anio }}</p>
        <p><strong>Total de Cursantes en el Mes:</strong> {{ $total_cursantes }}</p>
